...
export default function Home() {
  ...
  useEffect(() => {
    document.title = "Lynix Shop Sri Lanka - Premium Trending Tech & Fashion";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Shop the latest premium quality electronics, accessories, and trending gifts at Lynix. Fast island-wide delivery in Sri Lanka.");
